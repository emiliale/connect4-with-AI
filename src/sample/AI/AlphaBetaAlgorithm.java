...
public class AlphaBetaAlgorithm implements AI {
    ...
    public AlphaBetaAlgorithm(Board[][] Boards, int depth, int alpha, int beta, int max, boolean simple)
    {
        this.alpha = alpha;
        this.beta = beta;
        MAX_DEPTH = max;
        ...
        if(depth < MAX_DEPTH && this.value < 100 && this.value > -100 )
        {
            ...
            for(int i = 0; i < possibilities.size(); i++)
            {
                ...
                AlphaBetaAlgorithm child = new AlphaBetaAlgorithm(Boards, depth+1, this.alpha, this.beta, MAX_DEPTH, this.simple);
                prev.setColor("None");
